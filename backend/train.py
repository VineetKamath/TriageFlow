...
ZONE_NAMES = [
    # Bengaluru localities (20 zones)
    "MG Road", "Indiranagar", "Koramangala", "HSR Layout",
    "Whitefield", "Marathahalli", "Bellandur", "Sarjapur Road",
    "Jayanagar", "JP Nagar", "Banashankari", "Vijayanagar",
    "Malleshwaram", "Rajajinagar", "Hebbal", "RT Nagar",
    "KR Puram", "Yelahanka", "Peenya", "Electronic City",
]
...
# ---------------------------------------------------------------------------
# GeoJSON generation – 4 columns × 5 rows grid over Bengaluru
# ---------------------------------------------------------------------------

def generate_zones_geojson() -> dict:
    # Roughly covers central Bengaluru to ORR-ish area.
    base_lat, base_lng = 12.935, 77.56
    cell_h, cell_w = 0.015, 0.02
