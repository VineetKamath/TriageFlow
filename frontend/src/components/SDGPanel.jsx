...
export default function SDGPanel({
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 h-full w-[420px] z-[2200] bg-[#0F1218] border-l border-[rgba(255,255,255,0.07)] shadow-[-20px_0_60px_rgba(0,0,0,0.5)] p-6 overflow-y-auto"
    >
      <div className="flex justify-between items-center mb-5">
        <h2 className="font-mono-data text-[10px] uppercase tracking-[0.15em] text-[#3D4454]">Impact</h2>
        <button
          onClick={onClose}
      ...
      <p className="text-sm text-[#D4D8E0] mb-4 font-mono-data">
      ...
      <blockquote className="border-l-2 border-[#3D4454] pl-3 text-sm text-[#6B7280] mb-5 font-mono-data">
      ...
      <button
        ...
        className="w-full border border-[#3B8BEB] text-[#3B8BEB] hover:bg-[#1E2A3A] font-mono-data transition-all px-4 py-2 rounded"
      >
...
function Metric({ label, value }) {
  return (
    <div className="bg-[#141720] border border-[rgba(255,255,255,0.08)] rounded-xl p-4">
      <p className="font-mono-data text-[10px] uppercase tracking-widest text-white/40">{label}</p>
      <p className="font-mono-data text-3xl font-bold text-[#D4D8E0] mt-1">{value}</p>
    </div>
  );
}
